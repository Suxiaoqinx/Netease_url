...
可配合(https://github.com/GCLabGongchen/Script-for-Netease_url)实现批量下载等功能
...
> 基于https://github.com/Suxiaoqinx/Netease_url项目进行修改，添加更多功能。
## ✨ 功能特性
...
#### 1. 通过Github下载最新release

#### 2. 配置Cookie
在目录下生成的 `cookie.txt` 文件中填入黑胶会员账号的Cookie：
...
- 对于未整合的更新部分，请在 Github [Issues](https://github.com/GCLabGongchen/Netease_url_GCLab/issues) 提交反馈
